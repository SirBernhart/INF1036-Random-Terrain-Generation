...
public class EndelessTerrain : MonoBehaviour {
        ...
        for (int yOffset = -chunksVisibleInViewDistance; yOffset <= chunksVisibleInViewDistance; yOffset++) {
            for (int xOffset = -chunksVisibleInViewDistance; xOffset <= chunksVisibleInViewDistance; xOffset++) {
                ...
                if (terrainChunkDictionary.ContainsKey(viewedChuckCoord)) {
                    ...
                    terrainChunkDictionary.Add(viewedChuckCoord, new TerrainChunk(viewedChuckCoord, chunkSize, detailLevels, transform, mapMaterial));
                }
            ...
            if (mapDataReceived) {
                ...
                if (visible) {
                    ...
                    if (lodIndex != previousLODIndex) {
                        ...
                        } else if (!lodMesh.hasResquestedMesh) {
                            lodMesh.ResquestMesh(mapData);
                        }
                    }
                }
    ...
    class LODMesh {
        ...
        public void ResquestMesh (MapData mapData) {
            hasResquestedMesh = true;
